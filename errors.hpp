...
class bad_request_error : public error {
public:
  explicit bad_request_error(const std::string &what) : error(400, what) {}
};

class unauthorized_error : public error {
public:
...
class internal_server_error : public error {
public:
  explicit internal_server_error(const std::string &what) : error(500, what) {}
};

class service_unavailable_error : public error {
public:
